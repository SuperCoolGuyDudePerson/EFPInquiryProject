...
const AboutLanguages = () => {
 ...
 const handlePlayAudio = (files: string[]) => {
  if (!files || files.length === 0 || !audioRef.current) return;
  ...
  const playNext = () => {
    ...
    const filePath = `${basePath}${files[current].replace(/^\/+/, '')}`; // Removes leading slash
 ...
 return (
  <PageTransition>
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      {/* Additional Section: Language Family */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-stone-800 mb-6">The Salishan Language Family</h2>
            <p className="text-xl text-stone-600 max-w-4xl mx-auto">
              Both SENĆOŦEN and Halq'eméylem belong to the Salishan language family. This linguistic family represents 
              thousands of years of culture and history within North America.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <h3 className="text-xl font-bold text-stone-800 mb-4">Geographic Spread</h3>
              <p className="text-stone-600">
                Salishan languages span from British Columbia to Oregon.
            ...
            <motion.div
              ...
              className="bg-stone-50 p-8 rounded-xl"
            >
              <h3 className="text-xl font-bold text-stone-800 mb-4">Linguistic Features</h3>
              <p className="text-stone-600">
                Known for complex consonant clusters, and sophisticated 
                system of describing nature.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-stone-50 p-8 rounded-xl"
            >
              <h3 className="text-xl font-bold text-stone-800 mb-4">Language of Little Words</h3>
              <p className="text-stone-600">
               Despite being around for millenia, Salishan languages are reknowned for their small vocabulary.
              </p>
            </motion.div>
          </div>
        </div>
